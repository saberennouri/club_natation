        ...
        <table class="table">
            ...
            <tbody>
                ...
                while($row = $result->fetch_assoc()) {
                    echo "<tr>";
                    echo "<td>".$row['resultat_id']."</td>";
                    echo "<td>".$row['Nom_Competition']."</td>";
                    echo "<td>".$row['Date_Competition']."</td>";
                    echo "<td>".$row['Lieu']."</td>";
                    echo "<td>".$row['Position_Participant']."</td>";
                    echo "<td>".$row['Prenom_Athlete']." ".$row['Nom_Athlete']."</td>";
                    echo "<td>".$row['Classement_Performance']."</td>";
                    echo "<td>".$row['Temps_Performance']."</td>";
