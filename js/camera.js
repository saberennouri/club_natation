...
;(function($){$.fn.camera = function(opts, callback) {
	...
	var defaults = {
		...
		height				: '50.90%',	//here you can type pixels (for instance '300px'), a percentage (relative to the width of the slideshow, for instance '50%') or 'auto'		
		...
		minHeight			: 325,	//you can also leave it blank		
