                      ...
                      <div data-src="img/picture1.jpg">
                        <div class="camera_caption fadeIn">
                            <div class="camera_caption_bg">
                              <div class="title1"><p>apprendre à nager améliorer les compétences des nageurs avoir des champions.</p></div>
                            </div>
                        </div>
                      </div>
...
// Requête SQL pour sélectionner les données des comités
$sql = "SELECT c.nom AS nom_comite, c.description AS description_comite,  u.nom AS nom_responsable, u.email AS email_responsable 
FROM Comites c JOIN Utilisateurs u ON c.responsable_id = u.utilisateur_id";
$result = $conn->query($sql);


// Vérifier s'il y a des résultats
if ($result->num_rows > 0) {
    // Afficher les données des comités dans une table Bootstrap
    echo "<h2>Liste des Comités :</h2>";
    ...
    <th>email_responsable</th></tr></thead>";
    echo "<tbody>";
    while($row = $result->fetch_assoc()) {
        echo "<tr>";
        echo "<td>" . $row["nom_comite"] . "</td>";
        echo "<td>" . $row["description_comite"] . "</td>";
        echo "<td>" . $row["nom_responsable"] . "</td>";
        echo "<td>" . $row["email_responsable"] . "</td>";
